...
public class Player1Health : MonoBehaviour {
	...
	void Die(){
		...
		currentHealth = 0;
		transform.GetComponent<Player1Movement> ().enabled = false;
		transform.GetComponent<Player1Attack> ().enabled = false;
	...
	IEnumerator Respawn(){
		...
		transform.GetComponent<Player1Movement> ().enabled = true;
		transform.GetComponent<Player1Attack> ().enabled = true;
	}
