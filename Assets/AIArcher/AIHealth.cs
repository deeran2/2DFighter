...
public class AIHealth : MonoBehaviour {
	...
	void Die(){
		...
		currentHealth = 0;
		transform.GetComponent<AIMovement> ().enabled = false;
		transform.GetComponent<AIAttack> ().enabled = false;
	...
	IEnumerator Respawn(){
		...
		transform.GetComponent<AIMovement> ().enabled = true;
		transform.GetComponent<AIAttack> ().enabled = true;
	}
